...
class Season
{
    ...
    #[ORM\ManyToOne(inversedBy: 'seasons')] // Correspond au nom de l'attribut dans Serie
    #[ORM\JoinColumn(nullable: false)] // Ne pas ajouter [Groups['serie_api']] sinon ca recréé une référence circulaire
